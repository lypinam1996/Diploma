...
public class ArticlesEntity
{
    ...
    @JoinTable(name = "ProblemArticle", joinColumns = { @JoinColumn(name = "idArticle") }, inverseJoinColumns = {
    ...
    public boolean equals(Object o)
    {
        ...
        return idArticle == that.idArticle && Objects.equals(number, that.number) && Objects.equals(title, that.title)
                && Objects.equals(text, that.text) && Objects.equals(section, that.section);
    }
