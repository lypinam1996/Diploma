...
public class GrammarsEntity
{
    ...
    @ManyToMany
    @JoinTable(name = "WordformsGrammars", joinColumns = { @JoinColumn(name = "idGrammar") }, inverseJoinColumns = {
    ...
    @JoinTable(name = "GrammarsLemmas", joinColumns = { @JoinColumn(name = "idGrammar") }, inverseJoinColumns = {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(idGrammar, that.idGrammar) && Objects.equals(title, that.title) && Objects.equals(alias, that.alias)
