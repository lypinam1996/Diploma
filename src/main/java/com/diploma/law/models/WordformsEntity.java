...
public class WordformsEntity
{
    ...
    @JoinTable(name = "WordformsGrammars", joinColumns = { @JoinColumn(name = "idWordform") }, inverseJoinColumns = {
    ...
    public boolean equals(Object o)
    {
        ...
        return idWordform == that.idWordform && Objects.equals(title, that.title);
    }
