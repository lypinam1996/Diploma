...
public class LemmasEntity
{
    ...
    @JoinTable(name = "GrammarsLemmas", joinColumns = { @JoinColumn(name = "idLemma") }, inverseJoinColumns = {
    ...
    @LazyCollection(LazyCollectionOption.FALSE)
    @ManyToMany(cascade = CascadeType.ALL)
    @JoinTable(name = "ObjectsLemmas", joinColumns = { @JoinColumn(name = "idLemma") }, inverseJoinColumns = {
    ...
    public boolean equals(Object o)
    {
        ...
        return idLemma == that.idLemma && Objects.equals(title, that.title);
    }
